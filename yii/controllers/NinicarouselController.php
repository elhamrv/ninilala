...
/**
 * NinicarouselController implements the CRUD actions for Ninicarousel model.
 */
class NinicarouselController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $searchModel = new NinicarouselSearch();
    ...
    /**
     * Updates an existing Ninicarousel model.
